...
class AutocompleteManager {
  constructor () {
    ...
    this.triggerSuggestions = this.triggerSuggestions.bind(this)
  ...
  triggerSuggestions (event) {
    ...
    return this.findSuggestions(activatedManually, event.alt)
  }

  handleCommands () {
    return this.subscriptions.add(atom.commands.add('atom-text-editor', {
      'autocomplete-plus:activate': this.triggerSuggestions
    }))
  }

  // Private: Finds suggestions for the current prefix, sets the list items,
  // positions the overlay and shows it
  findSuggestions (activatedManually, alt) {
    ...
    return this.getSuggestionsFromProviders({editor: this.editor, bufferPosition, scopeDescriptor, prefix, activatedManually, alt})
  }
...
See https://github.com/atom/autocomplete-plus/wiki/Provider-API`
  ...
  requestNewSuggestions () {
    ...
    this.delayTimeout = setTimeout(this.findSuggestions, delay) // TODO trigger event instead
    this.shouldDisplaySuggestions = true
  }
